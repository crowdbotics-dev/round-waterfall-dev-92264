"""
Django settings for round_waterfall_dev_92264 project.
...
ROOT_URLCONF = 'round_waterfall_dev_92264.urls'
...
WSGI_APPLICATION = 'round_waterfall_dev_92264.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_waterfall_dev_92264 API",
    "DESCRIPTION": "API documentation for round_waterfall_dev_92264 App",
    "VERSION": "v1",
}
