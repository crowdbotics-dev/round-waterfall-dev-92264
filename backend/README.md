...
## Project Structure
    ...
    ├── round_waterfall_dev_92264  # Django project configurations
...
1. Clone this repo and `cd round_waterfall_dev_92264`
...
2. Clone this repo and `cd round_waterfall_dev_92264`
